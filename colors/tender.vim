...
hi @annotation guifg=#ffffff guibg=NONE
hi @attribute guifg=#ffffff guibg=NONE
hi @boolean guifg=#c9d05c guibg=NONE
hi @character guifg=#ffc24b guibg=NONE
hi @comment guifg=#666666 guibg=NONE
hi @conditional guifg=#73cef4 guibg=NONE
hi @const.builtin guifg=#f43753 guibg=NONE
hi @const.macro guifg=#d3b987 guibg=NONE
hi @constant guifg=#ffffff guibg=NONE
hi @constant.falsy guifg=#c9d05c guibg=NONE
hi @constructor guifg=#ffffff guibg=NONE
hi @error guifg=#ffc24b guibg=NONE
hi @exception guifg=#73cef4 guibg=NONE
hi @field guifg=#b3deef guibg=NONE
hi @float guifg=#ffffff guibg=NONE
hi @function guifg=#b3deef guibg=NONE
hi @function.builtin guifg=#b3deef guibg=NONE
hi @function.call guifg=#b3deef guibg=NONE
hi @function.macro guifg=#b3deef guibg=NONE
hi @include guifg=#73cef4 guibg=NONE
hi @keyword guifg=#73cef4 guibg=NONE
hi @keyword.coroutine guifg=#73cef4 guibg=NONE
hi @keyword.function guifg=#73cef4 guibg=NONE
hi @keyword.operator guifg=#73cef4 guibg=NONE
hi @keyword.return guifg=#73cef4 guibg=NONE
hi @label guifg=#ffffff guibg=NONE
hi @literal guifg=bbbbbb guibg=NONE
hi @method guifg=#b3deef guibg=NONE
hi @method.call guifg=#b3deef guibg=NONE
hi @namespace guifg=#ffc24b guibg=NONE
hi @number guifg=#ffffff guibg=NONE
hi @operator guifg=#f43753 guibg=NONE
hi @parameter guifg=#ffffff guibg=NONE
hi @parameter.reference guifg=#ffffff guibg=NONE
hi @property guifg=#b3deef guibg=NONE
hi @property.class guifg=#c9d05c guibg=NONE
hi @property.id guifg=#ffc24b guibg=NONE
hi @punctuation.bracket guifg=#73cef4 guibg=NONE
hi @punctuation.delimiter guifg=#73cef4 guibg=NONE
hi @punctuation.special guifg=#73cef4 guibg=NONE
hi @repeat guifg=#73cef4 guibg=NONE
hi @string guifg=#d3b987 guibg=NONE
hi @string.escape guifg=#ffc24b guibg=NONE
hi @string.regex guifg=#c9d05c guibg=NONE
hi @strong guifg=bbbbbb guibg=NONE
hi @structure guifg=bbbbbb guibg=NONE
hi @symbol guifg=bbbbbb guibg=NONE
hi @tag guifg=#b3deef guibg=NONE
hi @tag.attribute guifg=#73cef4 guibg=NONE
hi @tag.delimiter guifg=#73cef4 guibg=NONE
hi @text guifg=#ffffff guibg=NONE
hi @text.danger guifg=#f43753 guibg=NONE
hi @text.note guifg=bbbbbb guibg=NONE
hi @text.reference guifg=#b3deef guibg=NONE
hi @text.title guifg=#b3deef guibg=NONE
hi @text.title.1.marker guifg=#73cef4 guibg=NONE
hi @text.title.2.marker guifg=#73cef4 guibg=NONE
hi @text.title.3.marker guifg=#73cef4 guibg=NONE
hi @text.title.4.marker guifg=#73cef4 guibg=NONE
hi @text.todo guifg=bbbbbb guibg=NONE
hi @text.uri guifg=#c9d05c guibg=NONE
hi @text.warning guifg=#ffc24b guibg=NONE
hi @title guifg=#c9d05c guibg=NONE
hi @type guifg=#ffc24b guibg=NONE
hi @type.builtin guifg=#ffc24b guibg=NONE
hi @uri guifg=#d3b987 guibg=NONE
hi @variable guifg=#ffffff guibg=NONE
hi @variable.builtin guifg=#ffffff guibg=NONE

" Temporary fix for highlights broken by semantic groups
